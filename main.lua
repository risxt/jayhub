--[[
    ...
    HOW TO USE:
    1. Execute this script in Potassium
    2. Hub window will appear
    3. Toggle features on/off using the UI
    4. Press RightCtrl to minimize
    5. Use Settings tab to save/load config
]]
...
local Window = Fluent:CreateWindow({
    Title = "TapSim Hub",
    SubTitle = "v1.1 | Simulator Automation",
    TabWidth = 130,
...
-- MAIN TAB
-- ============================================
Tabs.Main:AddParagraph({ Title = "Auto Farm", Content = "Controls for automatic clicking and rebirth" })
...
Tabs.Main:AddParagraph({ Title = "Smart Rebirth", Content = "Nabung mode: Wait before buying highest tier" })
...
Tabs.Islands:AddParagraph({ Title = "Teleport (GPS Mode)", Content = "Instant teleport using hardcoded coordinates" })
...
-- UPGRADES TAB
-- ============================================
Tabs.Upgrades:AddParagraph({ Title = "Auto Upgrades", Content = "Automatically purchase upgrades and jump" })
